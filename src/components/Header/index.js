...
const Header = ({type}) =>{
    ...
    return(
        ...
        <rect x="1" y="1" width="27.17" height="27.1826" rx="13.585" fill="white" stroke="#1172EB" stroke-width="2"/>
        <path d="M12.7325 14.7177C12.6948 14.9284 12.6948 15.1446 12.7325 15.3553L12.4139 15.0365L12.7325 14.7177Z" stroke="#1172EB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
