...
const InputSearchProjetFunctionalities = ({name,placeholder,type,width,height,onChange}) =>{
    ...
    return(
        ...
        <input className="inputLogin" onChange={onChange} maxLength={100} type={type} placeholder={placeholder} style={input}/>
        </div>
    )

}

export default InputSearchProjetFunctionalities